...
(
  module.exports = {
    ...
    plugins: [
      ...
      // 🧠 Knowledge — its OWN docs instance (served at /knowledge): "things I know / how I
      // understand things". The durable MENTAL MODELS pulled up out of the topics (genai/companies/
      // interview-prep), regrouped by theme (ai/career/algorithms/interviewing). A first-class
      // durable root alongside Craft/Journey. id == routeBasePath (the simple case, no rename).
      [
        '@docusaurus/plugin-content-docs',
        {
          id: 'knowledge',
          ...
          sidebarPath: require.resolve('./sidebars-knowledge.js'),
          remarkPlugins: [remarkTaskList],
          rehypePlugins: [rehypeTaskListLabels, rehypePremiumEncrypt],
          editUrl:
            'https://github.com/omars-lab/omars-lab.github.io/edit/master/bytesofpurpose-blog/',
      ...
      [
        '@docusaurus/plugin-client-redirects',
        {
          redirects: [
            ...
            {from: "/docs/companies/mental-models", to: "/knowledge/career"},
            {from: "/docs/companies/mental-models/career-levels/staff-engineer-traits", to: "/knowledge/career/2025-10-02-staff-engineer-traits"},
            {from: "/docs/companies/mental-models/career-levels/understanding-sde-levels", to: "/knowledge/career/understanding-differences-in-skills"},
            {from: "/docs/companies/mental-models/cultural-values/understanding-tech-company-culture", to: "/knowledge/career/2025-09-25-understanding-cultural-values"},
            {from: "/docs/companies/mental-models/cultural-values/understanding-zapier-values", to: "/knowledge/career/2025-09-25-understanding-zapier-values"},
            {from: "/docs/companies/mental-models/skills/leadership-principles-companies-look-for", to: "/knowledge/career/understanding-desireable-leadership-skills"},
            {from: "/docs/companies/mental-models/skills/soft-skills-interview-evaluation", to: "/knowledge/career/understanding-desireable-soft-skills"},
            {from: "/docs/companies/mental-models/skills/technical-skills-interview-evaluation", to: "/knowledge/career/understanding-desireable-tech-skills"},
            ...
            {from: "/docs/craft/blogging/prompts", to: "/craft/software-development/prompts"},
            {from: "/docs/craft/blogging/prompts/blog-post-author", to: "/initiatives/blog-post-author"},
            {from: "/docs/craft/blogging/prompts/docusaurus-maintenance-system", to: "/initiatives/docusaurus-maintenance-system"},
            {from: "/docs/craft/blogging/prompts/evals", to: "/craft/software-development/prompts"},
            {from: "/docs/craft/blogging/prompts/evals/all-posts/audience-impression-check", to: "/initiatives/eval-audience-impression-check"},
            {from: "/docs/craft/blogging/prompts/evals/all-posts/evaluating-blog-personality", to: "/initiatives/eval-blog-personality"},
            {from: "/docs/craft/blogging/prompts/evals/all-posts/evaluating-content-quality", to: "/initiatives/eval-content-quality"},
            {from: "/docs/craft/blogging/prompts/evals/all-posts/general-blog-evaluation", to: "/initiatives/eval-general-blog"},
            {from: "/docs/craft/blogging/prompts/evals/specific-posts/evaluating-docs-vs-blogs", to: "/initiatives/eval-docs-vs-blogs"},
            {from: "/docs/craft/blogging/prompts/evals/specific-posts/evaluating-my-approach", to: "/initiatives/eval-my-approach"},
            {from: "/docs/craft/blogging/prompts/evals/specific-posts/evaluating-my-contributions", to: "/initiatives/eval-my-contributions"},
            {from: "/docs/craft/blogging/prompts/evals/specific-posts/evaluating-zapier-values", to: "/initiatives/eval-zapier-values"},
            {from: "/docs/craft/blogging/prompts/prompt-maturity-framework", to: "/initiatives/prompt-maturity-framework"},
            {from: "/docs/craft/blogging/prompts/role-refactoring-system", to: "/initiatives/role-refactoring-system"},
            {from: "/docs/craft/companies", to: "/craft/companies"},
            {from: "/docs/craft/companies/mental-models", to: "/knowledge/career"},
            {from: "/docs/craft/companies/mental-models/career-levels/2025-10-02-staff-engineer-traits", to: "/knowledge/career/2025-10-02-staff-engineer-traits"},
            {from: "/docs/craft/companies/mental-models/career-levels/understanding-differences-in-skills", to: "/knowledge/career/understanding-differences-in-skills"},
            {from: "/docs/craft/companies/mental-models/cultural-values/2025-09-25-understanding-cultural-values", to: "/knowledge/career/2025-09-25-understanding-cultural-values"},
            {from: "/docs/craft/companies/mental-models/cultural-values/2025-09-25-understanding-zapier-values", to: "/knowledge/career/2025-09-25-understanding-zapier-values"},
            {from: "/docs/craft/companies/mental-models/skills/understanding-desireable-leadership-skills", to: "/knowledge/career/understanding-desireable-leadership-skills"},
            {from: "/docs/craft/companies/mental-models/skills/understanding-desireable-soft-skills", to: "/knowledge/career/understanding-desireable-soft-skills"},
            {from: "/docs/craft/companies/mental-models/skills/understanding-desireable-tech-skills", to: "/knowledge/career/understanding-desireable-tech-skills"},
            ...
            {from: "/docs/craft/entrepreneurship", to: "/journey/entrepreneurship"},
            ...
            {from: "/docs/craft/generative-ai/mental-models", to: "/knowledge/ai"},
            {from: "/docs/craft/generative-ai/mental-models/2025-06-15-ai-engineer-world-fair", to: "/knowledge/ai/2025-06-15-ai-engineer-world-fair"},
            {from: "/docs/craft/generative-ai/mental-models/2025-07-30-understanding-the-fundamentals-of-genai", to: "/knowledge/ai/2025-07-30-understanding-the-fundamentals-of-genai"},
            {from: "/docs/craft/generative-ai/mental-models/2025-10-04-learning-about-genai", to: "/knowledge/ai/2025-10-04-learning-about-genai"},
            {from: "/docs/craft/generative-ai/mental-models/2025-11-10-ai-framework-landscape", to: "/knowledge/ai/2025-11-10-ai-framework-landscape"},
            ...
            {from: "/docs/craft/interview-prep/mental-models", to: "/knowledge/algorithms"},
            {from: "/docs/craft/interview-prep/mental-models/data-structures-and-algorithms/understanding-dynamic-programming", to: "/knowledge/algorithms/understanding-dynamic-programming"},
            {from: "/docs/craft/interview-prep/mental-models/data-structures-and-algorithms/understanding-graphs", to: "/knowledge/algorithms/understanding-graphs"},
            {from: "/docs/craft/interview-prep/mental-models/data-structures-and-algorithms/understanding-heaps", to: "/knowledge/algorithms/understanding-heaps"},
            {from: "/docs/craft/interview-prep/mental-models/data-structures-and-algorithms/understanding-lists", to: "/knowledge/algorithms/understanding-lists"},
            {from: "/docs/craft/interview-prep/mental-models/data-structures-and-algorithms/understanding-trees", to: "/knowledge/algorithms/understanding-trees"},
            {from: "/docs/craft/interview-prep/mental-models/understanding-the-interview-process", to: "/craft/interview-prep/process-interview"},
            ...
            {from: "/docs/craft/interview-prep/understanding-what-companies-expect", to: "/knowledge/interviewing/understanding-what-companies-expect"},
            ...
            // Project LOGS moved out of /craft (durable) into /initiatives (temporal, dated
            // acted-on work): the frontend-development/projects/* and scripting/projects/*
            // folders, plus a few automation/analytics logs and the Home Assistant tinker.
            // The durable index for these is the new /craft/software-development/projects hub.
            // Old /craft URLs 301 to the new /initiatives post. Only the PUBLISHED posts get a
            // redirect: a redirect target must be a real prod URL, and a draft post is excluded
            // from the prod build (the validate-redirects gate errors on a redirect→draft). The
            // still-draft moves (concept-graph, timeline-app, automate-*, etc.) had no public
            // /craft URL either, so nothing to preserve; add their redirect when each is
            // published. Existing /docs/* → /craft/* redirects that pointed at these published
            // posts were repointed straight to /initiatives above (chain collapse).
            {from: "/craft/productivity/automating/leveraging-shortcuts", to: "/initiatives/leveraging-shortcuts"},
            {from: "/craft/productivity/analyzing/leveraging-google-analytics", to: "/initiatives/leveraging-google-analytics"},
            {from: "/craft/software-development/frontend-development/projects/website-blog", to: "/initiatives/website-blog"},
            {from: "/craft/software-development/frontend-development/projects/website-portfolio", to: "/initiatives/website-portfolio"},
            {from: "/craft/software-development/scripting/projects/leveraging-terminal-shortcuts", to: "/initiatives/leveraging-terminal-shortcuts"},
            {from: "/craft/software-development/scripting/projects/parsing-json", to: "/initiatives/parsing-json"},
            {from: "/craft/software-development/scripting/projects/terminal-calendar", to: "/initiatives/terminal-calendar"},
            {from: "/craft/software-development/scripting/projects/terminal-links", to: "/initiatives/terminal-links"},
            {from: "/craft/software-development/workspace/setup/running-ha-on-mac-mini", to: "/initiatives/running-ha-on-mac-mini"},
            ...
            {from: "/docs/craft/productivity", to: "/journey/productivity"},
            {from: "/docs/craft/productivity/analyzing", to: "/habits/professional/analyzing"},
            {from: "/docs/craft/productivity/analyzing/leveraging-google-analytics", to: "/initiatives/leveraging-google-analytics"},
            {from: "/docs/craft/productivity/automating", to: "/habits/professional/automating"},
            {from: "/docs/craft/productivity/automating/leveraging-shortcuts", to: "/initiatives/leveraging-shortcuts"},
            {from: "/docs/craft/productivity/discovering", to: "/habits/professional/discovering"},
            {from: "/docs/craft/productivity/habits-automating", to: "/habits/professional/automating"},
            {from: "/docs/craft/productivity/organizing", to: "/habits/professional"},
            {from: "/docs/craft/productivity/processes/process-execution", to: "/habits/professional/execution"},
            {from: "/docs/craft/productivity/processes/process-interview", to: "/craft/interview-prep/process-interview"},
            {from: "/craft/productivity/processes/process-interview", to: "/craft/interview-prep/process-interview"},
            {from: "/docs/craft/productivity/prompts/daily-todo-carry-over", to: "/initiatives/daily-todo-carry-over"},
            {from: "/docs/craft/productivity/prompts/kanban-board-customization", to: "/initiatives/kanban-board-customization"},
            ...
            {from: "/docs/craft/productivity/tool-usage", to: "/craft/software-development/workspace/tool-usage"},
            {from: "/docs/craft/productivity/tool-usage/establishing-tool-usage-patterns", to: "/craft/software-development/workspace/tool-usage/establishing-tool-usage-patterns"},
            // IA reorg (2026-07): tool-usage moved productivity -> sw-dev/workspace; workspace/{tips,bookmarks}
            // moved up a level; the plugins topic merged into the Projects hub; process-interview moved to
            // interview-prep. Old public /craft/* URLs redirect straight to the new homes.
            {from: "/craft/productivity/tool-usage", to: "/craft/software-development/workspace/tool-usage"},
            {from: "/craft/productivity/tool-usage/establishing-tool-usage-patterns", to: "/craft/software-development/workspace/tool-usage/establishing-tool-usage-patterns"},
            {from: "/craft/software-development/plugins", to: "/craft/software-development/projects"},
            ...
            // Habits reconcile (2026-07): the productivity "X Techniques" folders (organizing,
            // discovering, analyzing, automating) + processes (execution, ideation) were folded into
            // /habits/professional as the practices they are. Published old URLs redirect to the new
            // habit home (drafts need none).
            {from: "/craft/productivity/analyzing", to: "/habits/professional/analyzing"},
            {from: "/craft/productivity/discovering", to: "/habits/professional/discovering"},
            {from: "/craft/productivity/processes/process-execution", to: "/habits/professional/execution"},
            ...
            {from: "/journey/personal-growth/prompts/personal-life-content-organizer", to: "/initiatives/personal-life-content-organizer"},
            // Prompt hub (2026-07): the prompt docs became kind: prompt /initiatives posts,
            // cataloged on the Prompts hub. Old /craft|journey|habits prompt URLs redirect to
            // /initiatives (the two index pages point at the hub).
            {from: "/craft/software-development/prompts/sql-query-analyzer", to: "/initiatives/sql-query-analyzer"},
            {from: "/craft/blogging/prompts/blog-post-author", to: "/initiatives/blog-post-author"},
            {from: "/craft/blogging/prompts/docusaurus-maintenance-system", to: "/initiatives/docusaurus-maintenance-system"},
            {from: "/craft/blogging/prompts/prompt-maturity-framework", to: "/initiatives/prompt-maturity-framework"},
            {from: "/craft/blogging/prompts/role-refactoring-system", to: "/initiatives/role-refactoring-system"},
            {from: "/craft/blogging/prompts/evals/all-posts/audience-impression-check", to: "/initiatives/eval-audience-impression-check"},
            {from: "/craft/blogging/prompts/evals/all-posts/evaluating-blog-personality", to: "/initiatives/eval-blog-personality"},
            {from: "/craft/blogging/prompts/evals/all-posts/evaluating-content-quality", to: "/initiatives/eval-content-quality"},
            {from: "/craft/blogging/prompts/evals/all-posts/general-blog-evaluation", to: "/initiatives/eval-general-blog"},
            {from: "/craft/blogging/prompts/evals/specific-posts/evaluating-docs-vs-blogs", to: "/initiatives/eval-docs-vs-blogs"},
            {from: "/craft/blogging/prompts/evals/specific-posts/evaluating-my-approach", to: "/initiatives/eval-my-approach"},
            {from: "/craft/blogging/prompts/evals/specific-posts/evaluating-my-contributions", to: "/initiatives/eval-my-contributions"},
            {from: "/craft/blogging/prompts/evals/specific-posts/evaluating-zapier-values", to: "/initiatives/eval-zapier-values"},
            {from: "/craft/blogging/prompts/evals", to: "/craft/software-development/prompts"},
            {from: "/craft/blogging/prompts", to: "/craft/software-development/prompts"},
            {from: "/journey/productivity/prompts/daily-todo-carry-over", to: "/initiatives/daily-todo-carry-over"},
            {from: "/journey/productivity/prompts/kanban-board-customization", to: "/initiatives/kanban-board-customization"},
            {from: "/habits/personal/prompts/personal-life-content-organizer", to: "/initiatives/personal-life-content-organizer"},
            ...
            {from: "/craft/entrepreneurship", to: "/journey/entrepreneurship"},
            {from: "/craft/productivity", to: "/journey/productivity"},
            {from: "/craft/productivity/prompts/daily-todo-carry-over", to: "/initiatives/daily-todo-carry-over"},
            {from: "/craft/productivity/prompts/kanban-board-customization", to: "/initiatives/kanban-board-customization"},
            ...
            // redirect straight to their new /knowledge home. (dfs-vs-bfs is draft -> no redirect.)
            {from: "/craft/generative-ai/mental-models", to: "/knowledge/ai"},
            {from: "/craft/generative-ai/mental-models/2025-06-15-ai-engineer-world-fair", to: "/knowledge/ai/2025-06-15-ai-engineer-world-fair"},
            {from: "/craft/generative-ai/mental-models/2025-07-30-understanding-the-fundamentals-of-genai", to: "/knowledge/ai/2025-07-30-understanding-the-fundamentals-of-genai"},
            {from: "/craft/generative-ai/mental-models/2025-10-04-learning-about-genai", to: "/knowledge/ai/2025-10-04-learning-about-genai"},
            {from: "/craft/generative-ai/mental-models/2025-11-10-ai-framework-landscape", to: "/knowledge/ai/2025-11-10-ai-framework-landscape"},
            {from: "/craft/companies/mental-models", to: "/knowledge/career"},
            {from: "/craft/companies/mental-models/career-levels/2025-10-02-staff-engineer-traits", to: "/knowledge/career/2025-10-02-staff-engineer-traits"},
            {from: "/craft/companies/mental-models/career-levels/understanding-differences-in-skills", to: "/knowledge/career/understanding-differences-in-skills"},
            {from: "/craft/companies/mental-models/cultural-values/2025-09-25-understanding-cultural-values", to: "/knowledge/career/2025-09-25-understanding-cultural-values"},
            {from: "/craft/companies/mental-models/cultural-values/2025-09-25-understanding-zapier-values", to: "/knowledge/career/2025-09-25-understanding-zapier-values"},
            {from: "/craft/companies/mental-models/skills/understanding-desireable-leadership-skills", to: "/knowledge/career/understanding-desireable-leadership-skills"},
            {from: "/craft/companies/mental-models/skills/understanding-desireable-soft-skills", to: "/knowledge/career/understanding-desireable-soft-skills"},
            {from: "/craft/companies/mental-models/skills/understanding-desireable-tech-skills", to: "/knowledge/career/understanding-desireable-tech-skills"},
            {from: "/craft/interview-prep/mental-models", to: "/knowledge/algorithms"},
            {from: "/craft/interview-prep/mental-models/understanding-the-interview-process", to: "/craft/interview-prep/process-interview"},
            {from: "/knowledge/interviewing/understanding-the-interview-process", to: "/craft/interview-prep/process-interview"},
            {from: "/craft/interview-prep/mental-models/data-structures-and-algorithms/understanding-dynamic-programming", to: "/knowledge/algorithms/understanding-dynamic-programming"},
            {from: "/craft/interview-prep/mental-models/data-structures-and-algorithms/understanding-graphs", to: "/knowledge/algorithms/understanding-graphs"},
            {from: "/craft/interview-prep/mental-models/data-structures-and-algorithms/understanding-heaps", to: "/knowledge/algorithms/understanding-heaps"},
            {from: "/craft/interview-prep/mental-models/data-structures-and-algorithms/understanding-lists", to: "/knowledge/algorithms/understanding-lists"},
            {from: "/craft/interview-prep/mental-models/data-structures-and-algorithms/understanding-trees", to: "/knowledge/algorithms/understanding-trees"},
            {from: "/craft/interview-prep/understanding-what-companies-expect", to: "/knowledge/interviewing/understanding-what-companies-expect"},
            // Techniques + Patterns hubs: the software-development techniques moved out of the
            // per-domain {backend,frontend}-development/techniques folders into flat /techniques
            // (how-to methods) + /patterns (architectural composition) hubs. Old /docs/* AND old
            // /craft/* URLs both redirect straight to the new flat homes (no chains).
            {from: "/docs/craft/software-development/backend-development/techniques", to: "/craft/software-development/techniques"},
            {from: "/craft/software-development/backend-development/techniques", to: "/craft/software-development/techniques"},
            {from: "/docs/craft/software-development/backend-development/techniques/ci-cd-techniques", to: "/craft/software-development/techniques/ci-cd-techniques"},
            {from: "/craft/software-development/backend-development/techniques/ci-cd-techniques", to: "/craft/software-development/techniques/ci-cd-techniques"},
            {from: "/docs/craft/software-development/backend-development/techniques/security-techniques", to: "/craft/software-development/techniques/security-techniques"},
            {from: "/craft/software-development/backend-development/techniques/security-techniques", to: "/craft/software-development/techniques/security-techniques"},
            {from: "/docs/craft/software-development/frontend-development/projects/website-blog", to: "/initiatives/website-blog"},
            {from: "/docs/craft/software-development/frontend-development/projects/website-portfolio", to: "/initiatives/website-portfolio"},
            {from: "/docs/craft/software-development/frontend-development/techniques/common-pitfalls", to: "/craft/software-development/patterns/storybook-typescript-babel/common-pitfalls"},
            {from: "/craft/software-development/frontend-development/techniques/common-pitfalls", to: "/craft/software-development/patterns/storybook-typescript-babel/common-pitfalls"},
            {from: "/docs/craft/software-development/frontend-development/techniques/development-process", to: "/craft/software-development/patterns/storybook-typescript-babel/development-process"},
            {from: "/craft/software-development/frontend-development/techniques/development-process", to: "/craft/software-development/patterns/storybook-typescript-babel/development-process"},
            {from: "/docs/craft/software-development/frontend-development/techniques/setup-overview", to: "/craft/software-development/patterns/storybook-typescript-babel/setup-overview"},
            {from: "/craft/software-development/frontend-development/techniques/setup-overview", to: "/craft/software-development/patterns/storybook-typescript-babel/setup-overview"},
            {from: "/docs/craft/software-development/frontend-development/techniques/storybook-typescript-babel", to: "/craft/software-development/patterns/storybook-typescript-babel"},
            {from: "/craft/software-development/frontend-development/techniques/storybook-typescript-babel", to: "/craft/software-development/patterns/storybook-typescript-babel"},
            {from: "/docs/craft/software-development/frontend-development/techniques/tool-composition", to: "/craft/software-development/techniques/tool-composition"},
            {from: "/craft/software-development/frontend-development/techniques/tool-composition", to: "/craft/software-development/techniques/tool-composition"},
            {from: "/craft/software-development/patterns/tool-composition", to: "/craft/software-development/techniques/tool-composition"},
            {from: "/docs/craft/software-development/frontend-development/techniques/understanding-tools", to: "/craft/software-development/patterns/storybook-typescript-babel/understanding-tools"},
            {from: "/craft/software-development/frontend-development/techniques/understanding-tools", to: "/craft/software-development/patterns/storybook-typescript-babel/understanding-tools"},
            {from: "/docs/craft/software-development/prompts/sql-query-analyzer", to: "/initiatives/sql-query-analyzer"},
            {from: "/docs/craft/software-development/scripting", to: "/craft/software-development/scripting"},
            {from: "/docs/craft/software-development/scripting/projects/leveraging-terminal-shortcuts", to: "/initiatives/leveraging-terminal-shortcuts"},
            {from: "/docs/craft/software-development/scripting/projects/parsing-json", to: "/initiatives/parsing-json"},
            {from: "/docs/craft/software-development/scripting/projects/terminal-calendar", to: "/initiatives/terminal-calendar"},
            ...
            {from: "/docs/craft/software-development/workspace/bookmarks/setup-machine", to: "/craft/software-development/bookmarks"},
            {from: "/craft/software-development/workspace/bookmarks/setup-machine", to: "/craft/software-development/bookmarks"},
            {from: "/docs/craft/software-development/workspace/setup/running-ha-on-mac-mini", to: "/initiatives/running-ha-on-mac-mini"},
            {from: "/docs/craft/software-development/workspace/tips", to: "/craft/software-development/tips"},
            {from: "/docs/craft/software-development/workspace/tools", to: "/craft/software-development/workspace/tools"},
            {from: "/docs/craftsmanship/bookmarks/setup-machine", to: "/craft/software-development/bookmarks"},
            {from: "/docs/craftsmanship/processes/my-personal-execution-process", to: "/habits/professional/execution"},
            {from: "/docs/craftsmanship/processes/technical-interview-process-complete-guide", to: "/craft/interview-prep/process-interview"},
            {from: "/docs/craftsmanship/tips/tips", to: "/craft/software-development/tips"},
            {from: "/docs/craftsmanship/tools/tools", to: "/craft/software-development/workspace/tools"},
            {from: "/docs/craftsmanship/workspace/autom8-ha-on-mac-mini", to: "/initiatives/running-ha-on-mac-mini"},
            ...
            {from: "/docs/development/projects/frontend-projects/sites/website-blog", to: "/initiatives/website-blog"},
            {from: "/docs/development/projects/frontend-projects/sites/website-portfolio", to: "/initiatives/website-portfolio"},
            ...
            {from: "/docs/entrepreneurship", to: "/journey/entrepreneurship"},
            {from: "/docs/faith", to: "/journey/faith"},
            {from: "/docs/generative-ai", to: "/craft/generative-ai"},
            {from: "/docs/generative-ai/mental-models", to: "/knowledge/ai"},
            {from: "/docs/generative-ai/mental-models/ai-engineer-world-fair-2025", to: "/knowledge/ai/2025-06-15-ai-engineer-world-fair"},
            ...
            {from: "/docs/interview-prep/mental-models/data-structures-and-algorithms/understanding-graphs", to: "/knowledge/algorithms/understanding-graphs"},
            {from: "/docs/interview-prep/mental-models/data-structures-and-algorithms/understanding-heaps", to: "/knowledge/algorithms/understanding-heaps"},
            {from: "/docs/interview-prep/mental-models/data-structures-and-algorithms/understanding-lists", to: "/knowledge/algorithms/understanding-lists"},
            {from: "/docs/interview-prep/mental-models/data-structures-and-algorithms/understanding-trees", to: "/knowledge/algorithms/understanding-trees"},
            {from: "/docs/interview-prep/mental-models/understanding-the-interview-process", to: "/craft/interview-prep/process-interview"},
            {from: "/docs/interview-prep/understanding-what-companies-expect", to: "/knowledge/interviewing/understanding-what-companies-expect"},
            {from: "/docs/mental-models/understanding-career-levels/staff-engineer-traits", to: "/knowledge/career/2025-10-02-staff-engineer-traits"},
            {from: "/docs/mental-models/understanding-career-levels/understanding-sde-levels", to: "/knowledge/career/understanding-differences-in-skills"},
            {from: "/docs/mental-models/understanding-cultural-values/understanding-tech-company-culture", to: "/knowledge/career/2025-09-25-understanding-cultural-values"},
            {from: "/docs/mental-models/understanding-cultural-values/understanding-zapier-values", to: "/knowledge/career/2025-09-25-understanding-zapier-values"},
            {from: "/docs/mental-models/understanding-data-structs-and-algos/understanding-dynamic-programming", to: "/knowledge/algorithms/understanding-dynamic-programming"},
            {from: "/docs/mental-models/understanding-data-structs-and-algos/understanding-graphs", to: "/knowledge/algorithms/understanding-graphs"},
            {from: "/docs/mental-models/understanding-data-structs-and-algos/understanding-heaps", to: "/knowledge/algorithms/understanding-heaps"},
            {from: "/docs/mental-models/understanding-data-structs-and-algos/understanding-lists", to: "/knowledge/algorithms/understanding-lists"},
            {from: "/docs/mental-models/understanding-data-structs-and-algos/understanding-trees", to: "/knowledge/algorithms/understanding-trees"},
            {from: "/docs/mental-models/understanding-processes/understanding-the-interview-process", to: "/craft/interview-prep/process-interview"},
            {from: "/docs/mental-models/understanding-skills/leadership-principles-companies-look-for", to: "/knowledge/career/understanding-desireable-leadership-skills"},
            {from: "/docs/mental-models/understanding-skills/soft-skills-interview-evaluation", to: "/knowledge/career/understanding-desireable-soft-skills"},
            {from: "/docs/mental-models/understanding-skills/technical-skills-interview-evaluation", to: "/knowledge/career/understanding-desireable-tech-skills"},
            {from: "/docs/mental-models/understanding-the-genai-domain/ai-engineer-world-fair-2025", to: "/knowledge/ai/2025-06-15-ai-engineer-world-fair"},
            ...
            {from: "/docs/prompts/analyze/sql-query-analyzer", to: "/initiatives/sql-query-analyzer"},
            {from: "/docs/prompts/author/blog-post-author", to: "/initiatives/blog-post-author"},
            {from: "/docs/prompts/draw/kanban-board-customization", to: "/initiatives/kanban-board-customization"},
            {from: "/docs/prompts/evals/all-posts/audience-impression-check", to: "/initiatives/eval-audience-impression-check"},
            {from: "/docs/prompts/evals/all-posts/evaluating-blog-personality", to: "/initiatives/eval-blog-personality"},
            {from: "/docs/prompts/evals/all-posts/evaluating-content-quality", to: "/initiatives/eval-content-quality"},
            {from: "/docs/prompts/evals/all-posts/general-blog-evaluation", to: "/initiatives/eval-general-blog"},
            {from: "/docs/prompts/evals/blog-post-evaluation-system", to: "/craft/software-development/prompts"},
            {from: "/docs/prompts/evals/specific-posts/evaluating-docs-vs-blogs", to: "/initiatives/eval-docs-vs-blogs"},
            {from: "/docs/prompts/evals/specific-posts/evaluating-my-approach", to: "/initiatives/eval-my-approach"},
            {from: "/docs/prompts/evals/specific-posts/evaluating-my-contributions", to: "/initiatives/eval-my-contributions"},
            {from: "/docs/prompts/evals/specific-posts/evaluating-zapier-values", to: "/initiatives/eval-zapier-values"},
            {from: "/docs/prompts/heal/docusaurus-maintenance-system", to: "/initiatives/docusaurus-maintenance-system"},
            {from: "/docs/prompts/meta/prompt-maturity-framework", to: "/initiatives/prompt-maturity-framework"},
            {from: "/docs/prompts/organize/daily-todo-carry-over", to: "/initiatives/daily-todo-carry-over"},
            {from: "/docs/prompts/organize/personal-life-content-organizer", to: "/initiatives/personal-life-content-organizer"},
            {from: "/docs/prompts/readme", to: "/craft/software-development/prompts"},
            {from: "/docs/prompts/refactor/role-refactoring-system", to: "/initiatives/role-refactoring-system"},
            ...
            {from: "/docs/self/personal-growth/prompts/personal-life-content-organizer", to: "/initiatives/personal-life-content-organizer"},
            ...
            {from: "/docs/techniques/analysis-techniques/analysis-techniques", to: "/habits/professional/analyzing"},
            {from: "/docs/techniques/analysis-techniques/leveraging-google-analytics", to: "/initiatives/leveraging-google-analytics"},
            {from: "/docs/techniques/automation-techniques/automation-techniques", to: "/habits/professional/automating"},
            {from: "/docs/techniques/automation-techniques/leveraging-shortcuts", to: "/initiatives/leveraging-shortcuts"},
            ...
            {from: "/docs/techniques/development-techniques/ci-cd-techniques", to: "/craft/software-development/techniques/ci-cd-techniques"},
            {from: "/docs/techniques/development-techniques/development-techniques", to: "/craft/software-development/techniques"},
            {from: "/docs/techniques/development-techniques/tool-composition-techniques/readme", to: "/craft/software-development/techniques/tool-composition"},
            {from: "/docs/techniques/development-techniques/tool-composition-techniques/storybook-typescript-babel/common-pitfalls", to: "/craft/software-development/patterns/storybook-typescript-babel/common-pitfalls"},
            {from: "/docs/techniques/development-techniques/tool-composition-techniques/storybook-typescript-babel/development-process", to: "/craft/software-development/patterns/storybook-typescript-babel/development-process"},
            {from: "/docs/techniques/development-techniques/tool-composition-techniques/storybook-typescript-babel/readme", to: "/craft/software-development/patterns/storybook-typescript-babel"},
            {from: "/docs/techniques/development-techniques/tool-composition-techniques/storybook-typescript-babel/setup-overview", to: "/craft/software-development/patterns/storybook-typescript-babel/setup-overview"},
            {from: "/docs/techniques/development-techniques/tool-composition-techniques/storybook-typescript-babel/understanding-tools", to: "/craft/software-development/patterns/storybook-typescript-babel/understanding-tools"},
            {from: "/docs/techniques/diagramming/diagramming", to: "/craft/blogging/diagramming"},
            {from: "/docs/techniques/discovery-techniques/discovery-techniques", to: "/habits/professional/discovering"},
            ...
            {from: "/docs/techniques/organization-techniques", to: "/habits/professional"},
            {from: "/docs/techniques/scripting-techniques/jq-mechanics", to: "/initiatives/parsing-json"},
            {from: "/docs/techniques/scripting-techniques/mechanic-terminal-links", to: "/initiatives/terminal-links"},
            {from: "/docs/techniques/scripting-techniques/terminal-calendar", to: "/initiatives/terminal-calendar"},
            {from: "/docs/techniques/scripting-techniques/terminal-shortcuts", to: "/initiatives/leveraging-terminal-shortcuts"},
            {from: "/docs/techniques/security-techniques/security-techniques", to: "/craft/software-development/techniques/security-techniques"},
            {from: "/docs/techniques/tool-usage-techniques/establishing-tool-usage-patterns", to: "/craft/software-development/workspace/tool-usage/establishing-tool-usage-patterns"},
            {from: "/docs/techniques/tool-usage-techniques/tool-usage-techniques", to: "/craft/software-development/workspace/tool-usage"},
          ],
      ...
      ({
        navbar: {
          ...
          items: [
            ...
            {
              // 'Knowledge' (the durable mental-models docs instance, id 'knowledge') — "things I
