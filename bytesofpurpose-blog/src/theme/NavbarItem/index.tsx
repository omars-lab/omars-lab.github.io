...
const SUMMARIES: Record<string, string> = {
  ...
  Mindset: 'The inputs I deliberately keep to shape how I think: the quotes that moved me, the affirmations I return to, and the questions I ask myself. Curated, not just occurred.',
