 ...
 * reloads. Votes remain signal-only in v1, with no live count or backend tally; the
...
export const IdeaVote: React.FC<IdeaVoteProps> = ({ idea }) => {
  ...
  // Read persisted state after mount (avoids SSR/hydration mismatch, since the server
