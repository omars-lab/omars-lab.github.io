...
const ANCHORS = [
  ...
  {file: TSX, needle: /function picketBoardScramble\b/, what: 'index.tsx: picketBoardScramble (the stable random board text at a mid-crossing REST in pickets; sized to the destination title so the scramble->title settle keeps the grid footprint)'},
