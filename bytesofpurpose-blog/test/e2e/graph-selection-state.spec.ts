...
test.describe('GraphRenderer Selection State E2E', () => {
  test.beforeEach(async ({ page }) => {
    ...
    const response = await page.goto('/craft/generative-ai/mental-models/2025-11-10-ai-framework-landscape', {
  ...
  test('clicking node after clicking edge unselects edge', async ({ page }) => {
    ...
    await page.goto(`/craft/generative-ai/mental-models/2025-11-10-ai-framework-landscape${edgeHash}`, {
      waitUntil: 'domcontentloaded',
    });
  ...
  test('clicking edge after clicking node unselects node', async ({ page }) => {
    ...
    await page.goto(`/craft/generative-ai/mental-models/2025-11-10-ai-framework-landscape${nodeHash}`, {
      waitUntil: 'domcontentloaded',
    });
