...
diagrams:
  ...
  - type: flow
    confidence: medium
    heading: 4.1 How a DIY Merchant Optimizes Conversion Today
  - type: flow
    confidence: medium
    heading: 6.1 Target State Overview
  - type: arch
    confidence: medium
    heading: 'Option 1: Drive a third-party A/B platform via API'
  - type: arch
    confidence: medium
    heading: 'Option 2: Self-hosted variant serving via JS snippet / edge worker'
  - type: arch
    confidence: medium
    heading: 'Option 3: Platform-native app (e.g., Shopify app/theme)'
  - type: arch
    confidence: medium
  ...
  - type: sequence
    confidence: high
    heading: '10.3 Sequence Diagram: Experiment Lifecycle'
---
