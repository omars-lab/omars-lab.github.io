...
graph LR
    ...
    style HEAL fill:#f5f5f5,stroke:#9e9e9e,stroke-dasharray: 5 5
    style sources fill:#fef7e0,stroke:#f9ab00
...
graph LR
    ...
    classDef people fill:#e6f4ea,stroke:#34a853
    classDef engine fill:#e8f0fe,stroke:#1a73e8
    classDef target fill:#fce8e6,stroke:#d93025
    classDef ext fill:#fef7e0,stroke:#f9ab00
    classDef note fill:#ffffff,stroke:#bdbdbd,color:#333
```
...
Phase 1 targets a **lean two-founder operation**. **[Assumption: all numeric targets below are starting hypotheses to validate with real runs, not committed SLAs.]**
...
graph LR
    ...
    style assumed fill:#fef7e0,stroke:#f9ab00
```
...
graph LR
    ...
    style OP fill:#e6f4ea,stroke:#34a853
    style JUDGE fill:#fce8e6,stroke:#d93025
    style CONTACT fill:#fce8e6,stroke:#d93025
```

**[Assumption: the team currently prospects manually with light tooling (search, spreadsheets, maybe a trial of one enrichment tool) rather than a paid stack.]** Each step is human-driven, serial, and unrecorded:
...
**[Assumption: the team is not currently paying for Clay or an equivalent orchestration stack: the agent is meant to be a purpose-built, ecommerce-specialized, cheaper-at-target-volume alternative, not a wrapper the team would otherwise rent.]**
...
graph LR
    ...
    style pipe fill:#e8f0fe,stroke:#1a73e8
...
graph LR
    ...
    style CLAY fill:#fef7e0,stroke:#f9ab00
...
graph LR
    ...
    style AGENT fill:#e8f0fe,stroke:#1a73e8
    style CC fill:#e6f4ea,stroke:#34a853
```
...
| Area | Leaning | Note |
|------|---------|------|
| Agent/orchestration | LLM agent with tool-calling (cheap-first stage logic) | **[Assumption: built around Claude as the reasoning engine for scan judgment, scoring rationale, and drafting.]** |
...
graph LR
    ...
    classDef engine fill:#e8f0fe,stroke:#1a73e8
    classDef people fill:#e6f4ea,stroke:#34a853
    classDef decision fill:#fce8e6,stroke:#d93025
...
- **LLM provider** for scan judgment, scoring rationale, and drafting (D7: **[Assumption: Claude]**).
