---
slug: /techniques/blogging-techniques/blog-post-triggers
...
[Docs vs Blog Posts](/docs/techniques/blogging-techniques/docs-vs-blog-posts) answers *which format* a piece of content
...
|---|---|---|---|
| `conference` | I attend a conference / event | [AI Engineer World Fair 2025](/docs/generative-ai/mental-models/ai-engineer-world-fair-2025) | one post per event |
...
| `milestone` | A repo or career milestone | [The Evolution of a Repository](/blog/evolution-of-a-repo) | per milestone |
...
- [Docs vs Blog Posts](/docs/techniques/blogging-techniques/docs-vs-blog-posts) — which *format* a piece of content takes.
- [Adding Blog Posts](/docs/techniques/blogging-techniques/adding-content/mx-docx-blog-posts) — the mechanics of authoring a post.
