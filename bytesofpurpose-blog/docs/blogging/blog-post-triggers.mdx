...
[Docs vs Blog Posts](/blog/docs-vs-blog-posts) answers *which format* a piece of content
...
|---|---|---|---|
| `conference` | I attend a conference / event | [AI Engineer World Fair 2025](/docs/mental-models/understanding-the-genai-domain/ai-engineer-world-fair-2025) | one post per event |
...
- [Docs vs Blog Posts](/blog/docs-vs-blog-posts) — which *format* a piece of content takes.
