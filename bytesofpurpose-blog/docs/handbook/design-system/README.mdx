...
- **🔤 [Typography](/handbook/design-system/typography):** Space Grotesk for display, Geist for body,
  Geist Mono for code, plus the type scale, weights, tracking, and line-heights, and the ten display
  faces compared.
