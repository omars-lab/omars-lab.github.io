---
slug: /components/structural/timeline
usage_pattern: '<Timeline'
kind: showcase
title: '🧩 Timeline'
...
[docusaurus.community: TimeLine](https://docusaurus.community/knowledge/component-library/new/TimeLine/)
...
<UsedIn slug="/components/structural/timeline" />
