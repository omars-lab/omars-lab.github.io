---
slug: /craft/interview-prep/coding-challenges/solutions/longest-palindromic-substring
title: Longest Palindromic Substring
description: 'Solutions for the Longest Palindromic Substring problem.'
authors: [oeid]
tags: [coding-challenges, algorithms, dynamic-programming]
draft: false
---
import BruteForceSvg from '/img/coding-challenges/longest-palindromic-substring/brute-force.svg';
import ExpandAroundCenterSvg from '/img/coding-challenges/longest-palindromic-substring/expand-around-center.svg';
import RecursiveSvg from '/img/coding-challenges/longest-palindromic-substring/recursive.svg';
...
<RecursiveSvg preserveAspectRatio="xMidYMid meet" width="100%" height="100%" className="recursive" />;
...
<ExpandAroundCenterSvg preserveAspectRatio="xMidYMid meet" width="100%" height="100%" className="expandAroundCenter" />;
...
* [Figma Diagram](https://embed.figma.com/board/dCF18hQlJfjflkf9p7MWga/Coding-Challenges?node-id=1-2&t=JNVkmhU4Nf1fWKFu-4&embed-host=share)
