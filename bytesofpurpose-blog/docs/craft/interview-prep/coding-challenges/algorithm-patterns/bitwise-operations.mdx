---
slug: /craft/interview-prep/coding-challenges/algorithm-patterns/bitwise-operations
	...
	* For bitwise operations ...
		* If summing # of bits in x AND y and x OR y ...
			* Its just the sum of the set bits in num 1 and 2 
				* [YouTube — TsuDUE 0pGA](https://youtu.be/TsuDUE-0pGA?list=PL9TOCZErLZcPbF_Z7_u3-Y7fPcYRMRepC&t=275)
				* Number of bits in x OR y
					* Max number of bits n x is ...
						* [geeksforgeeks.org — Count Set Bits In An Integer](https://www.geeksforgeeks.org/count-set-bits-in-an-integer/)
