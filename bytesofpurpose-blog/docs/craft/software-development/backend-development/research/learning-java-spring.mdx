---
slug: /craft/software-development/backend-development/research/learning-java-spring
...
* [ ] I need to lear more about spring
    ...
    * [ ] [springboottutorial.com — Spring Boot Application Configuration](https://www.springboottutorial.com/spring-boot-application-configuration)
    * [ ] [docs.spring.io — Html](https://docs.spring.io/spring-data/jpa/docs/current/reference/html/#repositories)
    * [ ] Look into: [tanzu.vmware.com](https://tanzu.vmware.com/content/springone-platform-2017/its-a-kind-of-magic-under-the-covers-of-spring-boot-brian-clozel-st%C3%A9phane-nicoll) >2021-08-30
