...
This is the durable index of the software I have built. Each project is a **dated build
log** that lives on the [Initiatives](/initiatives) blog: what I set out to make, what I
did, and what I learned. This page groups those logs by area so you can scan the whole
body of work at once.
