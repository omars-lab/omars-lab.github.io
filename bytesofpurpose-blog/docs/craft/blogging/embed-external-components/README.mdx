---
slug: /craft/blogging/embed-external-components
...
<!-- - [HTML Elements](/docs/craft/blogging/embed-external-components/html) - Embedding custom HTML elements -->
- [HTML React Elements](/docs/craft/blogging/embed-external-components/html-react-elements) - Embedding React components
<!-- - [Images - PNGs](/docs/craft/blogging/embed-external-components/images-pngs) - PNG image embedding and optimization -->
- [Images - SVGs](/docs/craft/blogging/embed-external-components/images-svgs) - SVG implementation and embedding
- [Videos - YouTube](/docs/craft/blogging/embed-external-components/videos-youtube) - YouTube video embedding
- [Tips](/docs/craft/blogging/embed-external-components/tips) - Tips and best practices for embedding external components
