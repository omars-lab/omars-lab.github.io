---
slug: /craft/blogging/blog-post-triggers
...
[Docs vs Blog Posts](/docs/craft/blogging/docs-vs-blog-posts) answers *which format* a piece of content
...
|---|---|---|---|
| `conference` | I attend a conference / event | [AI Engineer World Fair 2025](/docs/craft/generative-ai/mental-models/2025-06-15-ai-engineer-world-fair) | one post per event |
...
- [Docs vs Blog Posts](/docs/craft/blogging/docs-vs-blog-posts) — which *format* a piece of content takes.
- [Adding Blog Posts](/docs/craft/blogging/adding-content/adding-blog-posts) — the mechanics of authoring a post.
