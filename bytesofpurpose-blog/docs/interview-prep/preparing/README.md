...
- [ ] **Read [Interview Process](/docs/interview-prep/mental-models/understanding-the-interview-process)** - Learn the overall interview flow and what to expect
- [ ] **Study [SDE Skill Differences](/docs/companies/mental-models/career-levels/understanding-sde-levels)** - Understand the differences between SDE levels and expectations
- [ ] **Review [Leadership Principles](/docs/companies/mental-models/skills/leadership-principles-companies-look-for)** - Master the 10 core leadership principles and what interviewers look for
- [ ] **Study [Technical Skills Evaluation](/docs/companies/mental-models/skills/technical-skills-interview-evaluation)** - Learn the technical evaluation criteria
- [ ] **Review [Soft Skills Evaluation](/docs/companies/mental-models/skills/soft-skills-interview-evaluation)** - Learn the soft skills evaluation criteria
...
- [ ] **Study [Technical Skills Evaluation](/docs/companies/mental-models/skills/technical-skills-interview-evaluation)** - Understand what companies evaluate in technical interviews
...
- [ByteByteGo GenAI System Design Course](https://bytebytego.com/courses/genai-system-design-interview/introduction-and-overview) - Comprehensive GenAI system design interview preparation
- [System Design Primer](https://github.com/donnemartin/system-design-primer) - Complete guide to system design topics
- [Beginner's Guide to System Design](https://medium.com/@sentalkssane/a-beginners-guide-to-system-design-76d64689788b) - Introduction to system design concepts
- [Understanding Latency vs Throughput](https://community.cadence.com/cadence_blogs_8/b/fv/posts/understanding-latency-vs-throughput) - Key performance concepts
- [CAP Theorem Explained](http://ksat.me/a-plain-english-introduction-to-cap-theorem) - Plain English introduction to CAP theorem

### Coding Patterns & Algorithms
- [ByteByteGo Coding Patterns: Two Pointers](https://bytebytego.com/courses/coding-patterns/two-pointers/introduction-to-two-pointers) - Two pointers pattern tutorial
- [System Design Video Tutorial](https://www.youtube.com/watch?v=-W9F__D3oY4) - Visual system design walkthrough
