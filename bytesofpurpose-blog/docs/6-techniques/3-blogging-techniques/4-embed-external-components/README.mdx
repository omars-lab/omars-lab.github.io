...
- [HTML Elements](/docs/techniques/blogging-techniques/embed-external-components/html) - Embedding custom HTML elements
- [HTML React Elements](/docs/techniques/blogging-techniques/embed-external-components/html-react-elements) - Embedding React components
- [Images - PNGs](/docs/techniques/blogging-techniques/embed-external-components/images-pngs) - PNG image embedding and optimization
- [Images - SVGs](/docs/techniques/blogging-techniques/embed-external-components/images-svgs) - SVG implementation and embedding
- [Videos - YouTube](/docs/techniques/blogging-techniques/embed-external-components/videos-youtube) - YouTube video embedding
