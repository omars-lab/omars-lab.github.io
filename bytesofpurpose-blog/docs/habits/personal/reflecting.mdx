---
slug: /personal/reflecting
title: '🤔 Reflecting'
description: 'The habit of turning toward myself honestly: self-questioning, life-journey mapping, failure analysis, accountability, and reflecting on vision and purpose.'
authors: [oeid]
tags: [reflection, self-reflection, self-analysis, life-journey, failure-analysis, accountability, vision-reflection, purpose-reflection, questions]
draft: false
...
This is the durable side of self-questioning: not any one question, but the *practice* of turning
toward myself honestly and asking the hard thing. A good question asked of yourself does one job: it
makes the thing you have been avoiding hard to keep avoiding.

- **[What I Ask Myself](/handbook/what-i-ask-myself)**: how I run the practice, and the legend for
  the power icons on each question.
- **[All "ask myself" question sets](/questions/tags/ask-myself)**: the full collection I actually
  run, from finding your purpose to reflecting on your worth. Pick the one whose title stings a
  little, that is usually the one to start with.
