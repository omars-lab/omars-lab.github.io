...
```mermaid
flowchart LR
    Inspiration["Inspiration<br/>(immerse · observe · understand needs)"] --> Ideation["Ideation<br/>(synthesize · generate · prototype)"]
    Ideation --> Implementation["Implementation<br/>(build · test · bring to market)"]
    Ideation -. "learn & loop back" .-> Inspiration
    Implementation -. "learn & loop back" .-> Ideation
```
