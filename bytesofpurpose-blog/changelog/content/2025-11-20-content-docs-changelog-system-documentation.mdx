...
**Files Created:**
- [`docs/6-techniques/3-blogging-techniques/changelog-system.mdx`](/docs/craft/blogging/changelog-system) - Changelog system documentation in docs folder

**Files Enhanced:**
- [`docs/6-techniques/3-blogging-techniques/README.mdx`](/blogging) - Added link to changelog system documentation
- [`docs/6-techniques/3-blogging-techniques/5-adding-content/adding-changelog-entries.mdx`](/docs/craft/blogging/adding-content/adding-changelog-entries) - Updated reference to new location
